...
- Reviewable split-YAML filesystem projects with ordinary Git init/clone/status/aggregate-and-per-file-diff/selected-or-bulk-stage/unstaged-discard/commit-and-push/history/local-and-remote-branch/create/delete/fetch/pull/push/merge workflows
