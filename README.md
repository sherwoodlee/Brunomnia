...
node bin/brunomnia.cjs run collection workspace.brunomnia.json collection-id --request request-third --request request-first --requestNamePattern '^(Third|First)$' --env-var region=staging --delay-request 100 --data iterations.csv --bail
