...
- Reviewable split-YAML filesystem projects with ordinary Git init/clone/status/diff/stage/commit/history/local-and-remote-branch/fetch/pull/push/merge workflows
