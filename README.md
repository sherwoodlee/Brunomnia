...
- gRPC/GRPCS URL schemes, reflection, bounded multi-file/folder `.proto` import and compilation, dynamic JSON messages, all four call shapes, effective TLS validation overrides, and domain-scoped PEM client identity
