...
- gRPC/GRPCS URL schemes, reflection, pasted `.proto` compilation, dynamic JSON messages, all four call shapes, effective TLS validation overrides, and domain-scoped PEM client identity
