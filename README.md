...
- Local collections with persistent mixed folder/request drag and Option/Alt-keyboard ordering, indent/outdent, cross-collection moves, deep folder-subtree duplication, nested request folders, request/collection/folder documentation, and inherited folder headers, authentication, variables, and scripts
