...
- A headless CLI for OpenAPI lint/generation/export, collection execution, and standalone test-suite execution by suite or linked API-spec identity with regex test-name filtering, the documented Inso reporter names, and JSON/JUnit artifacts
