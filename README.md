...
- Multiple account-free local projects with create/switch/rename/duplicate-any/reorder/delete/restore workflows, a five-scope typed project-file inventory, same/cross-project file duplication with fresh nested identities, identity-preserving cross-project moves with owned local evidence, independent atomic files and encrypted vaults, legacy migration, rotating backups, catalog reconstruction, recently deleted management, and explicit corruption recovery
