...
- Reviewable split-YAML filesystem projects with ordinary Git init/clone/status/aggregate-and-per-file-diff/stage/unstaged-discard/commit/history/local-and-remote-branch/create/delete/fetch/pull/push/merge workflows
