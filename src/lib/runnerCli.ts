...
const runnerCliBooleanOptions = new Set([
  ...
  '--allow-external-vaults', '--allow-plugins', '--allow-config-code', '--disableCertValidation', '--disable-cert-validation', '-k', '--acceptRisk', '--accept-risk', '--keepFile', '--keep-file', '--skipAnnotations', '--skip-annotations', '-s', '--json', '--ci', '--verbose', '--printOptions', '--print-options', '--version', '-v', '--help', '-h',
]);
