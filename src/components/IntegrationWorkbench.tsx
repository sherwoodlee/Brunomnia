...
const mcpSessionConfigurationFields = new Set<keyof McpClient>(['transport', 'url', 'command', 'args', 'headers', 'authType', 'token', 'username', 'password', 'oauthAuthorizationUrl', 'oauthAccessTokenUrl', 'oauthClientId', 'oauthClientSecret', 'oauthScope', 'oauthState', 'oauthRegisteredClientId', 'oauthRegisteredClientSecret', 'oauthRegisteredClientIdIssuedAt', 'oauthRegisteredClientSecretExpiresAt', 'oauthRegisteredTokenEndpointAuthMethod']);
