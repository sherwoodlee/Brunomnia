...
export function Icon({ name, size = 18, ...props }: IconProps) {
  ...
  const content: Record<IconName, ReactNode> = {
    ...
    'eye-off': <><path d="m4 4 16 16" /><path d="M9.5 6.4A10.4 10.4 0 0 1 12 6c6 0 9.5 6 9.5 6a15.7 15.7 0 0 1-2.2 2.8M14.5 17.6A10.4 10.4 0 0 1 12 18c-6 0-9.5-6-9.5-6a15.7 15.7 0 0 1 2.2-2.8" /><path d="M10.2 10.2a2.5 2.5 0 0 0 3.6 3.6" /></>,
