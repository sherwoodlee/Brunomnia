...
export function PreferencesWorkbench({ workspace, onChangeWorkspace }: PreferencesWorkbenchProps) {
  ...
  return (
    <section className="preferences-workbench">
      <header className="preferences-header"><div><small>Device-local experience</small><h1>Preferences</h1><p>Appearance, request defaults, and keyboard bindings stay on this device when projects or encrypted revisions are opened.</p></div><Icon name="settings" size={27} /></header>
