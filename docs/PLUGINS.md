...
Milestone 264 extends the permissioned multi-file runtime with the pinned curated bare-module registry, manifest/source request review, explicit module grants, and the same portable behavior in desktop and CLI Workers. Plugins are local workspace data and every feature in this runtime is free.
