...
- Account-free regular/bulk read-only default controls and safe final-authored-row removal: [`src/App.tsx`](../src/App.tsx) and [`src/styles.css`](../src/styles.css)
